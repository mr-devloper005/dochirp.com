...
export const editableRootStyle = {
  ...
  '--slot4-panel-bg': '#f1ebe4',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#4f4a45',
  '--slot4-soft-muted-text': '#777069',
  '--slot4-accent': '#c7a38d',
  '--slot4-accent-fill': '#111111',
  '--slot4-accent-soft': '#ead8ca',
  '--slot4-dark-bg': '#050505',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#e5ddd5',
  '--slot4-cream': '#fbf8f3',
  '--slot4-warm': '#f7f4ef',
  '--slot4-lavender': '#f1ebe4',
  '--slot4-gray': '#ffffff',
  '--slot4-body-gradient': 'linear-gradient(180deg, #fbf8f3 0%, #f7f4ef 44%, #ffffff 100%)',
  '--editable-page-bg': '#f7f4ef',
...
export const editableDesignContract = {
  ...
  type: {
    ...
    heroTitle: 'text-4xl font-black leading-[0.98] tracking-tight sm:text-6xl lg:text-7xl',
  ...
  button: {
    primary: `inline-flex items-center justify-center rounded ${editablePalette.darkBg} px-8 py-3.5 text-sm font-black uppercase tracking-[0.14em] text-white transition hover:opacity-90`,
    secondary: `inline-flex items-center justify-center rounded border ${editablePalette.border} ${editablePalette.surfaceBg} px-8 py-3.5 text-sm font-black uppercase tracking-[0.14em] ${editablePalette.surfaceText} transition hover:bg-black/[0.03]`,
    accent: `inline-flex items-center justify-center rounded ${editablePalette.accentBg} px-8 py-3.5 text-sm font-black uppercase tracking-[0.14em] text-white transition hover:opacity-90`,
  },
  media: {
